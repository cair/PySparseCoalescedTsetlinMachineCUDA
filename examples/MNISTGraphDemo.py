...
tm = MultiClassGraphTsetlinMachine(args.number_of_clauses, args.T, args.s, (1, 26*26, args.hypervector_size), (1, 1), max_included_literals=args.max_included_literals)
